...
raw_path = r'C:\Users\salma\stock_market_de_project\datasets\raw_datasets'
...
cleaned_path = r'C:\Users\salma\stock_market_de_project\datasets\cleaned_dataset'
os.makedirs(cleaned_path, exist_ok=True)
combined_df.to_csv(os.path.join(cleaned_path, 'dse_cleaned_1999_2023.csv'), index=False)
print("Preprocessing complete. Cleaned data saved to:", os.path.join(cleaned_path, 'dse_cleaned_1999_2023.csv'))
